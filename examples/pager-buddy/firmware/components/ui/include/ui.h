...
typedef struct {
    ...
    bool connecting;                  // no live snapshot yet → show the "Connecting" screen (not sessions)
    const char *device;               // BLE advertising name ("pg-XXXX") — pairing hint on the connecting screen
